...
public class StudentService {
    ...
    public StudentService(Scanner scanner, StudentRepository studentRepository) { //service 생성할때 scanner와 repository 주소를 제공한다 는 뜻.
    ...
    public void showStudents() {
        ...
        for (int i = 0; i < students.length; i++) {
            ...
            if (student != null) {
                student.showStudentInfo();  // index 안의 학생들 정보 반복 표시.
            }
    ...
    public void deleteStudent() { //학생삭제
